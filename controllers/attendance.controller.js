...
// exports.createAttendance = async (req, res) => {
//   try {
//     const { day, count, group, name, present, absent } = req.body;

//     // Validate required fields
//     if (!day || !count || !group || !name || present == null || absent == null) {
//       return res.status(400).json({ error: "All fields (day, count, group, name, present, absent) are required" });
//     }

//     const newAttendance = new Attendance({ day, count, group, name, present, absent });
//     await newAttendance.save();
...
// //     let data;
// //     if (type === "daily") {
// //       data = await Attendance.find({ range: "daily" });
// //     } else if (type === "monthly") {
// //       data = await Attendance.find({ range: "monthly" });
// //     } else {
// //       data = await Attendance.find({ range: "weekly" });
// //     }
...
//     // Only filter if your schema actually has a "range" field
//     if (type && ["daily", "weekly", "monthly"].includes(type)) {
//       query.range = type;
//     }
